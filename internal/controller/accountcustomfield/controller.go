...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/accountcustomfield/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	...
	gvk := v1alpha1.GroupVersion.WithKind("AccountCustomField")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.AccountCustomField{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	if !ok {
		return nil, errors.New("expected *v1alpha1.AccountCustomField")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	_, resp, err := e.client.V2API.AccountCustomFieldGet(ctx).AccountCustomFieldGet(body).Execute()
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	...
	_, resp, err := e.client.V2API.AccountCustomFieldDelete(ctx).AccountCustomFieldDelete(body).Execute()
