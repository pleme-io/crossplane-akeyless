...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/authmethodapikey/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "AuthMethodApiKey"
	gvk := v1alpha1.GroupVersion.WithKind("AuthMethodApiKey")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.AuthMethodApiKey{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodApiKey)
	if !ok {
		return nil, errors.New("expected *v1alpha1.AuthMethodApiKey")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodApiKey)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.AuthMethodApiKey")
	}
	...
	_, resp, err := e.client.V2API.GetAuthMethod(ctx).GetAuthMethod(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodApiKey)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.AuthMethodApiKey")
	}

	body := akeyless.AuthMethodCreateApiKey{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	...
	_, _, err := e.client.V2API.AuthMethodCreateApiKey(ctx).AuthMethodCreateApiKey(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodApiKey)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.AuthMethodApiKey")
	}

	body := akeyless.AuthMethodUpdateApiKey{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AccessExpires: cr.Spec.ForProvider.AccessExpires,
		Description: cr.Spec.ForProvider.Description,
	...
	_, _, err := e.client.V2API.AuthMethodUpdateApiKey(ctx).AuthMethodUpdateApiKey(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodApiKey)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.AuthMethodApiKey")
	}

	body := akeyless.DeleteAuthMethod{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.DeleteAuthMethod(ctx).DeleteAuthMethod(body).Execute()
