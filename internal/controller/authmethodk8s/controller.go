...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/authmethodk8s/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "AuthMethodK8s"
	gvk := v1alpha1.GroupVersion.WithKind("AuthMethodK8s")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.AuthMethodK8s{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodK8s)
	if !ok {
		return nil, errors.New("expected *v1alpha1.AuthMethodK8s")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodK8s)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.AuthMethodK8s")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodK8s)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.AuthMethodK8s")
	}
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodK8s)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.AuthMethodK8s")
	}
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodK8s)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.AuthMethodK8s")
	}
