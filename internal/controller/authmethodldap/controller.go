...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/authmethodldap/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "AuthMethodLdap"
	gvk := v1alpha1.GroupVersion.WithKind("AuthMethodLdap")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.AuthMethodLdap{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodLdap)
	if !ok {
		return nil, errors.New("expected *v1alpha1.AuthMethodLdap")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodLdap)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.AuthMethodLdap")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodLdap)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.AuthMethodLdap")
	}

	body := akeyless.AuthMethodCreateLdap{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		...
		PublicKeyData: cr.Spec.ForProvider.PublicKeyData,
		UniqueIdentifier: cr.Spec.ForProvider.UniqueIdentifier,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.AuthMethodCreateLdap(ctx).AuthMethodCreateLdap(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodLdap)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.AuthMethodLdap")
	}

	body := akeyless.AuthMethodUpdateLdap{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AccessExpires: cr.Spec.ForProvider.AccessExpires,
		Description: cr.Spec.ForProvider.Description,
	...
	_, _, err := e.client.V2API.AuthMethodUpdateLdap(ctx).AuthMethodUpdateLdap(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodLdap)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.AuthMethodLdap")
	}
