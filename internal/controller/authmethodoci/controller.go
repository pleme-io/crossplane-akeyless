...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/authmethodoci/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "AuthMethodOci"
	gvk := v1alpha1.GroupVersion.WithKind("AuthMethodOci")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.AuthMethodOci{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOci)
	if !ok {
		return nil, errors.New("expected *v1alpha1.AuthMethodOci")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOci)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.AuthMethodOci")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOci)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.AuthMethodOci")
	}

	body := akeyless.AuthMethodCreateOCI{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		...
		TenantOcid: cr.Spec.ForProvider.TenantOcid,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.AuthMethodCreateOCI(ctx).AuthMethodCreateOCI(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOci)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.AuthMethodOci")
	}

	body := akeyless.AuthMethodUpdateOCI{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AccessExpires: cr.Spec.ForProvider.AccessExpires,
		Description: cr.Spec.ForProvider.Description,
	...
	_, _, err := e.client.V2API.AuthMethodUpdateOCI(ctx).AuthMethodUpdateOCI(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOci)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.AuthMethodOci")
	}
