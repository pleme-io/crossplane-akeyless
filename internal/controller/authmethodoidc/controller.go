...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/authmethodoidc/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "AuthMethodOidc"
	gvk := v1alpha1.GroupVersion.WithKind("AuthMethodOidc")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.AuthMethodOidc{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOidc)
	if !ok {
		return nil, errors.New("expected *v1alpha1.AuthMethodOidc")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOidc)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.AuthMethodOidc")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOidc)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.AuthMethodOidc")
	}

	body := akeyless.AuthMethodCreateOIDC{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		...
		RequiredScopesPrefix: cr.Spec.ForProvider.RequiredScopesPrefix,
		UniqueIdentifier: cr.Spec.ForProvider.UniqueIdentifier,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.AuthMethodCreateOIDC(ctx).AuthMethodCreateOIDC(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOidc)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.AuthMethodOidc")
	}

	body := akeyless.AuthMethodUpdateOIDC{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AccessExpires: cr.Spec.ForProvider.AccessExpires,
		Audience: cr.Spec.ForProvider.Audience,
	...
	_, _, err := e.client.V2API.AuthMethodUpdateOIDC(ctx).AuthMethodUpdateOIDC(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.AuthMethodOidc)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.AuthMethodOidc")
	}
