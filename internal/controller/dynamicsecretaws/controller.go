...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/dynamicsecretaws/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "DynamicSecretAws"
	gvk := v1alpha1.GroupVersion.WithKind("DynamicSecretAws")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.DynamicSecretAws{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretAws)
	if !ok {
		return nil, errors.New("expected *v1alpha1.DynamicSecretAws")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretAws)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.DynamicSecretAws")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretAws)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.DynamicSecretAws")
	}

	body := akeyless.DynamicSecretCreateAws{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AccessMode: cr.Spec.ForProvider.AccessMode,
		AdminRotationIntervalDays: cr.Spec.ForProvider.AdminRotationIntervalDays,
		AwsAccessKeyId: cr.Spec.ForProvider.AwsAccessKeyId,
		AwsAccessSecretKey: cr.Spec.ForProvider.AwsAccessSecretKey,
		AwsExternalId: cr.Spec.ForProvider.AwsExternalId,
		AwsRoleArns: cr.Spec.ForProvider.AwsRoleArns,
		AwsUserConsoleAccess: cr.Spec.ForProvider.AwsUserConsoleAccess,
		AwsUserGroups: cr.Spec.ForProvider.AwsUserGroups,
		AwsUserPolicies: cr.Spec.ForProvider.AwsUserPolicies,
		AwsUserProgrammaticAccess: cr.Spec.ForProvider.AwsUserProgrammaticAccess,
		...
		SessionTags: cr.Spec.ForProvider.SessionTags,
		TargetName: cr.Spec.ForProvider.TargetName,
		TransitiveTagKeys: cr.Spec.ForProvider.TransitiveTagKeys,
		UserTtl: cr.Spec.ForProvider.UserTtl,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.DynamicSecretCreateAws(ctx).DynamicSecretCreateAws(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretAws)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.DynamicSecretAws")
	}

	body := akeyless.DynamicSecretUpdateAws{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AccessMode: cr.Spec.ForProvider.AccessMode,
		AdminRotationIntervalDays: cr.Spec.ForProvider.AdminRotationIntervalDays,
	...
	_, _, err := e.client.V2API.DynamicSecretUpdateAws(ctx).DynamicSecretUpdateAws(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretAws)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.DynamicSecretAws")
	}
