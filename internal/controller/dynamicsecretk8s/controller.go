...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/dynamicsecretk8s/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "DynamicSecretK8s"
	gvk := v1alpha1.GroupVersion.WithKind("DynamicSecretK8s")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.DynamicSecretK8s{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretK8s)
	if !ok {
		return nil, errors.New("expected *v1alpha1.DynamicSecretK8s")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretK8s)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.DynamicSecretK8s")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretK8s)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.DynamicSecretK8s")
	}
	...
	body := akeyless.DynamicSecretCreateK8s{
		...
		K8sAllowedNamespaces: cr.Spec.ForProvider.K8sAllowedNamespaces,
		...
		K8sPredefinedRoleName: cr.Spec.ForProvider.K8sPredefinedRoleName,
		K8sPredefinedRoleType: cr.Spec.ForProvider.K8sPredefinedRoleType,
		K8sRolebindingYamlData: cr.Spec.ForProvider.K8sRolebindingYamlData,
		K8sRolebindingYamlDef: cr.Spec.ForProvider.K8sRolebindingYamlDef,
		K8sServiceAccount: cr.Spec.ForProvider.K8sServiceAccount,
		K8sServiceAccountType: cr.Spec.ForProvider.K8sServiceAccountType,
		...
		SecureAccessDashboardUrl: cr.Spec.ForProvider.SecureAccessDashboardUrl,
	...
	_, _, err := e.client.V2API.DynamicSecretCreateK8s(ctx).DynamicSecretCreateK8s(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretK8s)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.DynamicSecretK8s")
	}
	...
	_, _, err := e.client.V2API.DynamicSecretUpdateK8s(ctx).DynamicSecretUpdateK8s(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretK8s)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.DynamicSecretK8s")
	}
