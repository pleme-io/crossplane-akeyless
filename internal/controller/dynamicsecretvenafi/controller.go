...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/dynamicsecretvenafi/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "DynamicSecretVenafi"
	gvk := v1alpha1.GroupVersion.WithKind("DynamicSecretVenafi")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.DynamicSecretVenafi{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretVenafi)
	if !ok {
		return nil, errors.New("expected *v1alpha1.DynamicSecretVenafi")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretVenafi)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.DynamicSecretVenafi")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretVenafi)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.DynamicSecretVenafi")
	}

	body := akeyless.DynamicSecretCreateVenafi{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		...
		AutoGeneratedFolder: cr.Spec.ForProvider.AutoGeneratedFolder,
		...
		RootFirstInChain: cr.Spec.ForProvider.RootFirstInChain,
		SignUsingAkeylessPki: cr.Spec.ForProvider.SignUsingAkeylessPki,
		SignerKeyName: cr.Spec.ForProvider.SignerKeyName,
		StorePrivateKey: cr.Spec.ForProvider.StorePrivateKey,
		TargetName: cr.Spec.ForProvider.TargetName,
		UserTtl: cr.Spec.ForProvider.UserTtl,
		VenafiAccessToken: cr.Spec.ForProvider.VenafiAccessToken,
		VenafiApiKey: cr.Spec.ForProvider.VenafiApiKey,
		VenafiBaseurl: cr.Spec.ForProvider.VenafiBaseurl,
		VenafiClientId: cr.Spec.ForProvider.VenafiClientId,
		VenafiRefreshToken: cr.Spec.ForProvider.VenafiRefreshToken,
		VenafiUseTpp: cr.Spec.ForProvider.VenafiUseTpp,
		VenafiZone: cr.Spec.ForProvider.VenafiZone,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.DynamicSecretCreateVenafi(ctx).DynamicSecretCreateVenafi(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretVenafi)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.DynamicSecretVenafi")
	}

	body := akeyless.DynamicSecretUpdateVenafi{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AdminRotationIntervalDays: cr.Spec.ForProvider.AdminRotationIntervalDays,
		AllowSubdomains: cr.Spec.ForProvider.AllowSubdomains,
	...
	_, _, err := e.client.V2API.DynamicSecretUpdateVenafi(ctx).DynamicSecretUpdateVenafi(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.DynamicSecretVenafi)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.DynamicSecretVenafi")
	}
