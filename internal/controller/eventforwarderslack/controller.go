...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/eventforwarderslack/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "EventForwarderSlack"
	gvk := v1alpha1.GroupVersion.WithKind("EventForwarderSlack")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.EventForwarderSlack{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.EventForwarderSlack)
	if !ok {
		return nil, errors.New("expected *v1alpha1.EventForwarderSlack")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.EventForwarderSlack)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.EventForwarderSlack")
	}
	...
	_, resp, err := e.client.V2API.GetEventForwarder(ctx).GetEventForwarder(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.EventForwarderSlack)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.EventForwarderSlack")
	}

	body := akeyless.EventForwarderCreateSlack{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	...
	_, _, err := e.client.V2API.EventForwarderCreateSlack(ctx).EventForwarderCreateSlack(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.EventForwarderSlack)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.EventForwarderSlack")
	}

	body := akeyless.EventForwarderUpdateSlack{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		Description: cr.Spec.ForProvider.Description,
		Key: cr.Spec.ForProvider.Key,
	...
	_, _, err := e.client.V2API.EventForwarderUpdateSlack(ctx).EventForwarderUpdateSlack(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.EventForwarderSlack)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.EventForwarderSlack")
	}
	...
	_, resp, err := e.client.V2API.EventForwarderDelete(ctx).EventForwarderDelete(body).Execute()
