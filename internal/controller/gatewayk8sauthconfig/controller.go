...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/gatewayk8sauthconfig/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "GatewayK8sAuthConfig"
	gvk := v1alpha1.GroupVersion.WithKind("GatewayK8sAuthConfig")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.GatewayK8sAuthConfig{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.GatewayK8sAuthConfig)
	if !ok {
		return nil, errors.New("expected *v1alpha1.GatewayK8sAuthConfig")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.GatewayK8sAuthConfig)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.GatewayK8sAuthConfig")
	}
	...
	_, resp, err := e.client.V2API.GatewayGetK8SAuthConfig(ctx).GatewayGetK8SAuthConfig(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.GatewayK8sAuthConfig)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.GatewayK8sAuthConfig")
	}
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.GatewayK8sAuthConfig)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.GatewayK8sAuthConfig")
	}
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.GatewayK8sAuthConfig)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.GatewayK8sAuthConfig")
	}

	body := akeyless.GatewayDeleteK8SAuthConfig{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.GatewayDeleteK8SAuthConfig(ctx).GatewayDeleteK8SAuthConfig(body).Execute()
