...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	_, _, err := e.client.V2API.GatewayGetK8SAuthConfig(ctx).GatewayGetK8SAuthConfig(body).Execute()
	if err != nil {
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	...
	_, _, err := e.client.V2API.GatewayDeleteK8SAuthConfig(ctx).GatewayDeleteK8SAuthConfig(body).Execute()
