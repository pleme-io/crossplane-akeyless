...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/group/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "Group"
	gvk := v1alpha1.GroupVersion.WithKind("Group")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.Group{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	if !ok {
		return nil, errors.New("expected *v1alpha1.Group")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.Group)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.Group")
	}

	body := akeyless.GetGroup{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.GetGroup(ctx).GetGroup(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.Group)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.Group")
	}
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.Group)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.Group")
	}
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.Group)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.Group")
	}

	body := akeyless.DeleteGroup{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.DeleteGroup(ctx).DeleteGroup(body).Execute()
