...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/kmipclient/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "KmipClient"
	gvk := v1alpha1.GroupVersion.WithKind("KmipClient")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.KmipClient{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.KmipClient)
	if !ok {
		return nil, errors.New("expected *v1alpha1.KmipClient")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.KmipClient)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.KmipClient")
	}

	name := meta.GetExternalName(cr)
	body := akeyless.KmipDescribeClient{
		Name: &name,
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.KmipDescribeClient(ctx).KmipDescribeClient(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.KmipClient)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.KmipClient")
	}
...
func (e *external) Update(_ context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	_, ok := mg.(*v1alpha1.KmipClient)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.KmipClient")
	}
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.KmipClient)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.KmipClient")
	}

	name := meta.GetExternalName(cr)
	body := akeyless.KmipDeleteClient{
		Name: &name,
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.KmipDeleteClient(ctx).KmipDeleteClient(body).Execute()
