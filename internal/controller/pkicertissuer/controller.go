...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/pkicertissuer/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "PkiCertIssuer"
	gvk := v1alpha1.GroupVersion.WithKind("PkiCertIssuer")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.PkiCertIssuer{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.PkiCertIssuer)
	if !ok {
		return nil, errors.New("expected *v1alpha1.PkiCertIssuer")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.PkiCertIssuer)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.PkiCertIssuer")
	}
	...
	_, resp, err := e.client.V2API.DescribeItem(ctx).DescribeItem(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.PkiCertIssuer)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.PkiCertIssuer")
	}

	body := akeyless.CreatePKICertIssuer{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AllowAnyName: cr.Spec.ForProvider.AllowAnyName,
		AllowCopyExtFromCsr: cr.Spec.ForProvider.AllowCopyExtFromCsr,
		AllowSubdomains: cr.Spec.ForProvider.AllowSubdomains,
		AllowedDomains: cr.Spec.ForProvider.AllowedDomains,
		AllowedExtraExtensions: cr.Spec.ForProvider.AllowedExtraExtensions,
		AllowedIpSans: cr.Spec.ForProvider.AllowedIpSans,
		AllowedUriSans: cr.Spec.ForProvider.AllowedUriSans,
		AutoRenew: cr.Spec.ForProvider.AutoRenew,
		CaTarget: cr.Spec.ForProvider.CaTarget,
		ClientFlag: cr.Spec.ForProvider.ClientFlag,
		CodeSigningFlag: cr.Spec.ForProvider.CodeSigningFlag,
		Country: cr.Spec.ForProvider.Country,
		CreatePrivateCrl: cr.Spec.ForProvider.CreatePrivateCrl,
		CreatePrivateOcsp: cr.Spec.ForProvider.CreatePrivateOcsp,
		CreatePublicCrl: cr.Spec.ForProvider.CreatePublicCrl,
		CreatePublicOcsp: cr.Spec.ForProvider.CreatePublicOcsp,
		CriticalKeyUsage: cr.Spec.ForProvider.CriticalKeyUsage,
		Description: cr.Spec.ForProvider.Description,
		DestinationPath: cr.Spec.ForProvider.DestinationPath,
		DisableWildcards: cr.Spec.ForProvider.DisableWildcards,
		EnableAcme: cr.Spec.ForProvider.EnableAcme,
		GwClusterUrl: cr.Spec.ForProvider.GwClusterUrl,
		IsCa: cr.Spec.ForProvider.IsCa,
		KeyUsage: cr.Spec.ForProvider.KeyUsage,
		Locality: cr.Spec.ForProvider.Locality,
		MaxPathLen: cr.Spec.ForProvider.MaxPathLen,
		NotEnforceHostnames: cr.Spec.ForProvider.NotEnforceHostnames,
		NotRequireCn: cr.Spec.ForProvider.NotRequireCn,
		OcspTtl: cr.Spec.ForProvider.OcspTtl,
		OrganizationalUnits: cr.Spec.ForProvider.OrganizationalUnits,
		Organizations: cr.Spec.ForProvider.Organizations,
		PostalCode: cr.Spec.ForProvider.PostalCode,
		ProtectCertificates: cr.Spec.ForProvider.ProtectCertificates,
		Province: cr.Spec.ForProvider.Province,
		ScheduledRenew: cr.Spec.ForProvider.ScheduledRenew,
		ServerFlag: cr.Spec.ForProvider.ServerFlag,
		SignerKeyName: cr.Spec.ForProvider.SignerKeyName,
		StreetAddress: cr.Spec.ForProvider.StreetAddress,
		Ttl: cr.Spec.ForProvider.Ttl,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.CreatePKICertIssuer(ctx).CreatePKICertIssuer(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.PkiCertIssuer)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.PkiCertIssuer")
	}
	...
	_, _, err := e.client.V2API.UpdatePKICertIssuer(ctx).UpdatePKICertIssuer(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.PkiCertIssuer)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.PkiCertIssuer")
	}
	...
	_, resp, err := e.client.V2API.DeleteItem(ctx).DeleteItem(body).Execute()
