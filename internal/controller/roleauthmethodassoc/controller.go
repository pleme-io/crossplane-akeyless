...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/roleauthmethodassoc/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "RoleAuthMethodAssoc"
	gvk := v1alpha1.GroupVersion.WithKind("RoleAuthMethodAssoc")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.RoleAuthMethodAssoc{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.RoleAuthMethodAssoc)
	if !ok {
		return nil, errors.New("expected *v1alpha1.RoleAuthMethodAssoc")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.RoleAuthMethodAssoc)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.RoleAuthMethodAssoc")
	}
	...
	_, resp, err := e.client.V2API.GetRole(ctx).GetRole(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.RoleAuthMethodAssoc)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.RoleAuthMethodAssoc")
	}

	body := akeyless.AssocRoleAuthMethod{
		RoleName: cr.Spec.ForProvider.RoleName,
		AmName: cr.Spec.ForProvider.AmName,
		Token: &e.token,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.AssocRoleAuthMethod(ctx).AssocRoleAuthMethod(body).Execute()
...
func (e *external) Update(_ context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	_, ok := mg.(*v1alpha1.RoleAuthMethodAssoc)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.RoleAuthMethodAssoc")
	}
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.RoleAuthMethodAssoc)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.RoleAuthMethodAssoc")
	}

	body := akeyless.DeleteRoleAssociation{
		AssocId: meta.GetExternalName(cr),
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.DeleteRoleAssociation(ctx).DeleteRoleAssociation(body).Execute()
