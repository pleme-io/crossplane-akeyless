...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/rolerule/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "RoleRule"
	gvk := v1alpha1.GroupVersion.WithKind("RoleRule")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.RoleRule{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	if !ok {
		return nil, errors.New("expected *v1alpha1.RoleRule")
	}
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	...
	_, resp, err := e.client.V2API.DeleteRoleRule(ctx).DeleteRoleRule(body).Execute()
