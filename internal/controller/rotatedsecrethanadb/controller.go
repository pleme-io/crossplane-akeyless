...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/rotatedsecrethanadb/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "RotatedSecretHanadb"
	gvk := v1alpha1.GroupVersion.WithKind("RotatedSecretHanadb")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.RotatedSecretHanadb{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretHanadb)
	if !ok {
		return nil, errors.New("expected *v1alpha1.RotatedSecretHanadb")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretHanadb)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.RotatedSecretHanadb")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretHanadb)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.RotatedSecretHanadb")
	}

	body := akeyless.RotatedSecretCreateHanadb{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.RotatedSecretCreateHanadb(ctx).RotatedSecretCreateHanadb(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretHanadb)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.RotatedSecretHanadb")
	}

	body := akeyless.RotatedSecretUpdateHanadb{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map mutable cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.RotatedSecretUpdateHanadb(ctx).RotatedSecretUpdateHanadb(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretHanadb)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.RotatedSecretHanadb")
	}
