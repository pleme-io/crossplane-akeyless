...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/rotatedsecretmysql/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "RotatedSecretMysql"
	gvk := v1alpha1.GroupVersion.WithKind("RotatedSecretMysql")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.RotatedSecretMysql{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretMysql)
	if !ok {
		return nil, errors.New("expected *v1alpha1.RotatedSecretMysql")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretMysql)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.RotatedSecretMysql")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretMysql)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.RotatedSecretMysql")
	}

	body := akeyless.RotatedSecretCreateMysql{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.RotatedSecretCreateMysql(ctx).RotatedSecretCreateMysql(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretMysql)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.RotatedSecretMysql")
	}

	body := akeyless.RotatedSecretUpdateMysql{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	// TODO controller-iter-2: map mutable cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.RotatedSecretUpdateMysql(ctx).RotatedSecretUpdateMysql(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretMysql)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.RotatedSecretMysql")
	}
