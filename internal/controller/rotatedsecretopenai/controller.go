...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/rotatedsecretopenai/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "RotatedSecretOpenai"
	gvk := v1alpha1.GroupVersion.WithKind("RotatedSecretOpenai")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.RotatedSecretOpenai{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretOpenai)
	if !ok {
		return nil, errors.New("expected *v1alpha1.RotatedSecretOpenai")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretOpenai)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.RotatedSecretOpenai")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretOpenai)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.RotatedSecretOpenai")
	}

	body := akeyless.RotatedSecretCreateOpenAI{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	...
	_, _, err := e.client.V2API.RotatedSecretCreateOpenAI(ctx).RotatedSecretCreateOpenAI(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretOpenai)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.RotatedSecretOpenai")
	}

	body := akeyless.RotatedSecretUpdateOpenAI{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		ApiKey: cr.Spec.ForProvider.ApiKey,
		ApiKeyId: cr.Spec.ForProvider.ApiKeyId,
	...
	_, _, err := e.client.V2API.RotatedSecretUpdateOpenAI(ctx).RotatedSecretUpdateOpenAI(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretOpenai)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.RotatedSecretOpenai")
	}
