...
package rotatedsecretpostgresql
...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/rotatedsecretpostgresql/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "RotatedSecretPostgresql"
	gvk := v1alpha1.GroupVersion.WithKind("RotatedSecretPostgresql")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.RotatedSecretPostgresql{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretPostgresql)
	if !ok {
		return nil, errors.New("expected *v1alpha1.RotatedSecretPostgresql")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretPostgresql)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.RotatedSecretPostgresql")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretPostgresql)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.RotatedSecretPostgresql")
	}

	body := akeyless.RotatedSecretCreatePostgresql{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	...
	_, _, err := e.client.V2API.RotatedSecretCreatePostgresql(ctx).RotatedSecretCreatePostgresql(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretPostgresql)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.RotatedSecretPostgresql")
	}

	body := akeyless.RotatedSecretUpdatePostgresql{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AuthenticationCredentials: cr.Spec.ForProvider.AuthenticationCredentials,
		AutoRotate: cr.Spec.ForProvider.AutoRotate,
	...
	_, _, err := e.client.V2API.RotatedSecretUpdatePostgresql(ctx).RotatedSecretUpdatePostgresql(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.RotatedSecretPostgresql)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.RotatedSecretPostgresql")
	}
