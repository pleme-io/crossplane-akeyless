...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/targetdb/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "TargetDb"
	gvk := v1alpha1.GroupVersion.WithKind("TargetDb")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.TargetDb{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.TargetDb)
	if !ok {
		return nil, errors.New("expected *v1alpha1.TargetDb")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.TargetDb)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.TargetDb")
	}

	body := akeyless.TargetGet{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.TargetGet(ctx).TargetGet(body).Execute()
	if err != nil {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.TargetDb)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.TargetDb")
	}

	body := akeyless.TargetCreateDB{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		...
		CloudServiceProvider: cr.Spec.ForProvider.CloudServiceProvider,
		ClusterMode: cr.Spec.ForProvider.ClusterMode,
		...
		OracleWalletLoginType: cr.Spec.ForProvider.OracleWalletLoginType,
		OracleWalletP12FileData: cr.Spec.ForProvider.OracleWalletP12FileData,
		OracleWalletSsoFileData: cr.Spec.ForProvider.OracleWalletSsoFileData,
		ParentTargetName: cr.Spec.ForProvider.ParentTargetName,
		Port: cr.Spec.ForProvider.Port,
		Pwd: cr.Spec.ForProvider.Pwd,
		SnowflakeAccount: cr.Spec.ForProvider.SnowflakeAccount,
		SnowflakeApiPrivateKey: cr.Spec.ForProvider.SnowflakeApiPrivateKey,
		SnowflakeApiPrivateKeyPassword: cr.Spec.ForProvider.SnowflakeApiPrivateKeyPassword,
		Ssl: cr.Spec.ForProvider.Ssl,
		SslCertificate: cr.Spec.ForProvider.SslCertificate,
		UserName: cr.Spec.ForProvider.UserName,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.TargetCreateDB(ctx).TargetCreateDB(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.TargetDb)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.TargetDb")
	}

	body := akeyless.TargetUpdateDB{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		AzureClientId: cr.Spec.ForProvider.AzureClientId,
		AzureClientSecret: cr.Spec.ForProvider.AzureClientSecret,
	...
	_, _, err := e.client.V2API.TargetUpdateDB(ctx).TargetUpdateDB(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.TargetDb)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.TargetDb")
	}

	body := akeyless.TargetDelete{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	}
	_, resp, err := e.client.V2API.TargetDelete(ctx).TargetDelete(body).Execute()
