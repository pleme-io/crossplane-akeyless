...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/targethashivault/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "TargetHashiVault"
	gvk := v1alpha1.GroupVersion.WithKind("TargetHashiVault")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.TargetHashiVault{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.TargetHashiVault)
	if !ok {
		return nil, errors.New("expected *v1alpha1.TargetHashiVault")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.TargetHashiVault)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.TargetHashiVault")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.TargetHashiVault)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.TargetHashiVault")
	}

	body := akeyless.TargetCreateHashiVault{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		...
		VaultToken: cr.Spec.ForProvider.VaultToken,
	}
	// TODO controller-iter-2: map cr.Spec.ForProvider fields → body fields
	_, _, err := e.client.V2API.TargetCreateHashiVault(ctx).TargetCreateHashiVault(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.TargetHashiVault)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.TargetHashiVault")
	}

	body := akeyless.TargetUpdateHashiVault{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		Description: cr.Spec.ForProvider.Description,
		HashiUrl: cr.Spec.ForProvider.HashiUrl,
	...
	_, _, err := e.client.V2API.TargetUpdateHashiVault(ctx).TargetUpdateHashiVault(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.TargetHashiVault)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.TargetHashiVault")
	}
