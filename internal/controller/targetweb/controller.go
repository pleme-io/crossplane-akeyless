...
import (
	...
	v1alpha1 "github.com/pleme-io/crossplane-akeyless/apis/targetweb/v1alpha1"
...
func Setup(mgr ctrl.Manager, pollInterval time.Duration) error {
	name := "TargetWeb"
	gvk := v1alpha1.GroupVersion.WithKind("TargetWeb")
	...
	return ctrl.NewControllerManagedBy(mgr).Named(name).For(&v1alpha1.TargetWeb{}).Complete(r)
}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*v1alpha1.TargetWeb)
	if !ok {
		return nil, errors.New("expected *v1alpha1.TargetWeb")
	}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	cr, ok := mg.(*v1alpha1.TargetWeb)
	if !ok {
		return managed.ExternalObservation{}, errors.New("expected *v1alpha1.TargetWeb")
	}
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	cr, ok := mg.(*v1alpha1.TargetWeb)
	if !ok {
		return managed.ExternalCreation{}, errors.New("expected *v1alpha1.TargetWeb")
	}

	body := akeyless.TargetCreateWeb{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
	...
	_, _, err := e.client.V2API.TargetCreateWeb(ctx).TargetCreateWeb(body).Execute()
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	cr, ok := mg.(*v1alpha1.TargetWeb)
	if !ok {
		return managed.ExternalUpdate{}, errors.New("expected *v1alpha1.TargetWeb")
	}

	body := akeyless.TargetUpdateWeb{
		Name: meta.GetExternalName(cr),
		Token: &e.token,
		Description: cr.Spec.ForProvider.Description,
		Key: cr.Spec.ForProvider.Key,
	...
	_, _, err := e.client.V2API.TargetUpdateWeb(ctx).TargetUpdateWeb(body).Execute()
...
func (e *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	cr, ok := mg.(*v1alpha1.TargetWeb)
	if !ok {
		return managed.ExternalDelete{}, errors.New("expected *v1alpha1.TargetWeb")
	}
